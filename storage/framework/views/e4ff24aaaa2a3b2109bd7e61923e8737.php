...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($title ?? 'МокроНос'); ?></title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:18px;overflow:hidden;">
                ...
                <tr>
                    <td style="background:#2c241d;color:#fff;padding:20px;text-align:center;font-size:14px;">
                        ...
                        <p style="margin:0;">© <?php echo e(date('Y')); ?> МокроНос</p>
                    </td>
                </tr>
...
</html><?php /**PATH C:\Users\AdminPC\Herd\mokronose\resources\views/emails/layout.blade.php ENDPATH**/ ?>