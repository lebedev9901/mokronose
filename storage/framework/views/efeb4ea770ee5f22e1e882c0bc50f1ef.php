...
<div class="pay__container flex">
    ...
    <div class="pay__card flex">
         ...
         <div class="pay__card-text flex">
            ...
            <p class="pay__card-text-descr">
                Вы можете оплатить заказ онлайн после подтверждения менеджером (ВКонтакте или на сайте).
    ...
    <div class="pay__delivery-services">
        ...
        <div class="pay__service">
            <img src="<?php echo e(asset('assets/img/cdek.svg')); ?>" alt="СДЭК">
            <span>СДЭК</span>
        </div>

        <div class="pay__service">
            <img src="<?php echo e(asset('assets/img/yandex-market.png')); ?>" alt="Яндекс Маркет">
            <span>Яндекс Маркет</span>
        </div>

        <div class="pay__service">
            <img src="<?php echo e(asset('assets/img/pochta_russia.png')); ?>" alt="Почта России">
    ...
    <p class="pay__highlight">
    🚚 Доставка до двери доступна через СДЭК
</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AdminPC\Herd\mokronose\resources\views/pages/pay.blade.php ENDPATH**/ ?>