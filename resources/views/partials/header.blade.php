<header class="header">
            <div class="container">
                <div class="header__contain flex">
                    <div class="header__contain-top flex">
                        <a href="{{route('home')}}"><img class="header__logo" src="{{asset('assets/img/logotype.png')}}" alt="logotype"></a>
                        <div class="header__text flex">
                            <h2 class="header__title">МокроНос</h2>
                            <p class="header__descr">лакомства для собак</p>
                        </div>
                        
                        <ul class="header__addr list-reset flex" >
                            <li class="header__addr-item">
                                МО, г. Подольск
                            </li>
                            <li class="header__addr-item">
                    ...
                    <div class="header__contain-bottom flex">
                     
                            <form class="header__search" action="{{route('catalog')}}" method="GET">
                        ...
                        <div class="header__enter flex">
                               @auth
                                ...
                                @else
                            <a href="{{route('login')}}" class="btn-reset header__login" id="login">Вход
                            ...
                            <a  href="{{route('cart')}}" class="btn-reset">
                                Корзина <span class="cart-count {{ ($cartCount ?? 0) <= 0 ? 'is-hidden' : '' }}" id="cart-count">
                                    {{ $cartCount ?? 0 }}
                                </span>
